...
@Component({
  selector: 'app-lista-detalhe-encaminhamento',
  templateUrl: './lista-detalhe-encaminhamento.component.html',
  styleUrls: ['./lista-detalhe-encaminhamento.component.css']
})
export class ListaDetalheEncaminhamentoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    else if (routeState.data.assunto >= -1) {
      this.detalhe = false;
      this.filtroPagina.pagina = 0;
